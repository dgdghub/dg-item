...
<script>
  ...
  <link rel="icon" href="<?php empty($this->options->favicon)? $this->options->themeUrl('/assets/image/fav.png') : $this->options->favicon(); ?>" type="image/x-icon" />
  <link rel="shortcut icon" href="<?php empty($this->options->favicon)? $this->options->themeUrl('/assets/image/fav.png') : $this->options->favicon(); ?>" type="image/x-icon" >
